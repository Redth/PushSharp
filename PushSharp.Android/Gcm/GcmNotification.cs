...
namespace PushSharp.Android
{
    public class GcmNotification : Notification
    {
        ...
        public static GcmNotification ForTopicResult(GcmMessageTransportResponse response)
        {
            var result = new GcmNotification();
            result.Tag = response.Message.Tag;
            result.CollapseKey = response.Message.CollapseKey;
        ...
        public static GcmNotification ForTopic(GcmNotification msg)
        {
            var result = new GcmNotification();
            result.Tag = msg.Tag;
        ...
        /// <summary>
		/// Topic which you can use to send message to. 
		/// Devices then can subscribe to it.
		/// </summary>
		public string Topic
        {
            get;
        ...
        internal string GetJson()
        {
            ...
            if (this.RegistrationIds.Any()) json["registration_ids"] = new JArray(this.RegistrationIds.ToArray());
